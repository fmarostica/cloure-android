...
public class FinancesOperationsAdapter extends ArrayAdapter<Operation> {
    private final Context context;
    private final ArrayList<Operation> values;

    public FinancesOperationsAdapter(Context context, ArrayList<Operation> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Operation register = values.get(position);
