...
public class DebitCards {
    public static ArrayList<DebitCard> get_list(String filtro){
        ArrayList<DebitCard> items = new ArrayList<>();
        try{
            ...
            if(error.equals("")){
                ...
                for (int i=0; i<registros.length(); i++){
                    ...
                    DebitCard register_tmp = new DebitCard();
    ...
    public static DebitCard get(int Id){
        DebitCard item = new DebitCard();
        try{
            ArrayList<CloureParam> params = new ArrayList<>();
            params.add(new CloureParam("module", "debit_cards"));
    ...
    public static JSONObject Save(DebitCard item){
