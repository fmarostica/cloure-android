...
public class ProductsTypesAdapter extends ArrayAdapter<ProductServiceType> {
    private final Context context;
    private final ArrayList<ProductServiceType> values;

    public ProductsTypesAdapter(Context context, ArrayList<ProductServiceType> values) {
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final View view = mInflater.inflate(R.layout.row_single_adapter, parent, false);
