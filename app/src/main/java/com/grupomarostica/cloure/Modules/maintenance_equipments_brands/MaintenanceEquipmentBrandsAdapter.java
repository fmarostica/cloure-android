...
public class MaintenanceEquipmentBrandsAdapter extends ArrayAdapter<MaintenanceEquipmentBrand> {
    private final Context context;
    private final ArrayList<MaintenanceEquipmentBrand> values;

    public MaintenanceEquipmentBrandsAdapter(Context context, ArrayList<MaintenanceEquipmentBrand> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        MaintenanceEquipmentBrand register = values.get(position);
