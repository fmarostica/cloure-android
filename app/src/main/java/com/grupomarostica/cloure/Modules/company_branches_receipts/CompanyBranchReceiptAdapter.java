...
public class CompanyBranchReceiptAdapter extends ArrayAdapter<CompanyBranchReceipt> {
    private final Context context;
    private final ArrayList<CompanyBranchReceipt> values;

    public CompanyBranchReceiptAdapter(Context context, ArrayList<CompanyBranchReceipt> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CompanyBranchReceipt register = values.get(position);
