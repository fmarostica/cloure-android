...
public class ProductsServicesUnitsAdapter extends ArrayAdapter {
    private final Context context;
    private final ArrayList<ProductServiceUnit> values;

    public ProductsServicesUnitsAdapter(Context context, ArrayList<ProductServiceUnit> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ProductServiceUnit register = values.get(position);
